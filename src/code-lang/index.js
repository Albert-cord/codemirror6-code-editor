...
const mvelHighlighting = /*@__PURE__*/styleTags({
  null: tags.null,
    instanceof: tags.operatorKeyword,
  this: tags.self,
  "new assert to with void": tags.keyword,
  "var def": tags.definitionKeyword,
  "module package import": tags.moduleKeyword,
  "switch while foreach if else case default do break continue return try catch finally throw": tags.controlKeyword,
  ...
  IdentifierPrefix: tags.variableName,
  ...
  "( )": tags.paren,
  "[ ]": tags.squareBracket,
  "@DEFINE_BEGIN @END": tags.brace,
  "{ }": tags.brace,
  ".": tags.derefOperator,
  ", ;": tags.separator,
  AssignValuer: /*@__PURE__*/tags.special(tags.float),
  "AssignValuer/IntegerLiteral": /*@__PURE__*/tags.special(tags.float),
  "AssignValuer/float": /*@__PURE__*/tags.special(tags.float),
  "AssignValuer/FloatingPointLiteral": /*@__PURE__*/tags.special(tags.float),
  "AssignValuer!": /*@__PURE__*/tags.special(tags.float),
  "AssignValuer/...": /*@__PURE__*/tags.special(tags.float),
  "（ ）": /*@__PURE__*/tags.special(tags.float),
});
...
const keywords = /*@__PURE__*/"this @END @DEFINE_BEGIN foreach assert break case continue default delete extends false finally in instanceof let new return static super switch this throw true typeof var yield  byte short int long char float double boolean".split(" ").map(kwCompletion);
const snips = [
    ...
    /*@__PURE__*/snippetCompletion("for (int ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}", {
        label: "for",
        detail: "loop",
        type: "keyword"
    }),
    /*@__PURE__*/snippetCompletion("for (${name}: ${collection}) {\n\t${}\n}", {
        label: "for",
        detail: "for ele loop",
        type: "keyword"
    }),
    ...
    /*@__PURE__*/snippetCompletion("@DEFINE_BEGIN ${name} \n\t${}\n@END", {
        label: "@DEFINE_BEGIN",
...
const mvelLanguage = /*@__PURE__*/LRLanguage.define({
    name: "mvel",
    parser: /*@__PURE__*/parser.configure({
        props: [
            /*@__PURE__*/indentNodeProp.add({
                ...
                IndexDefineBlock: /*@__PURE__*/delimitedIndent({ closing: "@END" }),
                ExpressionDefineBlock: /*@__PURE__*/delimitedIndent({ closing: "@END" }),
                BlockComment: () => null,
            ...
            /*@__PURE__*/foldNodeProp.add({
                ["Block SwitchBlock ClassBody ElementValueArrayInitializer ModuleBody EnumBody " +
                    "ConstructorBody InterfaceBody ArrayInitializer IndexDefineBlock ExpressionDefineBlock"]: foldInside,
...
// 定义自动补全插件
const mvelCompletionPlugin = /*@__PURE__*/mvelLanguage.data.of({
    autocomplete: mvelCompletionSource
});
/// Java language support.
function mvel() {
    // return new LanguageSupport(mvelLanguage, [mvelCompletionPlugin, mvelLintPlugin]);
    return new LanguageSupport(mvelLanguage, [mvelCompletionPlugin]);
}
